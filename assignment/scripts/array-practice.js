...
let favoriteFoods = ['pizza', 'steak', 'chips', 'ice cream'];
...
favoriteFoods.unshift('fruit');
console.log(`Added fruit to the beginning: ${favoriteFoods}`);
